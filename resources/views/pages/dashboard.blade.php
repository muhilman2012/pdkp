                    ...
                    <div class="flex flex-col w-full gap-2">
                        <div class="flex justify-between items-start">
                            <div class="flex flex-col gap-1">
                                <p class="text-xs ">Lokasi penugasan pelayanan</p>
                                <p class="text-xs ">14.01 WIB</p>
                            </div>
                            <div class="bg-gold py-1 px-2 rounded text-white">
                                <p class="font-bold text-xs">WAPRES</p>
                            </div>
                        </div>
                        <p class="font-semibold text-sm line-clamp-3">Deskripsi penugasan Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit, sed do eiusmod
                            tempor incididunt ut labore et dolore magna aliqua. Aliquam eleifend mi in nulla posuere
                            sollicitudin aliquam ultrices sagittis. Posuere sollicitudin aliquam ultrices sagittis orci
                            a scelerisque purus. Amet consectetur adipiscing elit ut aliquam purus sit amet luctus. Quis
                            blandit turpis cursus in hac habitasse platea dictumst.</p>
                        <div class="flex justify-between items-center italic text-black text-xs">
                            <p>Kendaraan, Pengemudi</p>
                            <p>oleh Hengky Wijaya</p>
                        </div>
                    </div>
                </a>
            </div>
