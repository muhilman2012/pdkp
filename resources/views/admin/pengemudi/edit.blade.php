...
<div class="container-fluid">
    <div class="d-block rounded bg-white shadow">
        ...
        <div class="d-block p-3">
            <form action="{{ route('admin.pengemudi.update', ['id' => $data->id_pengemudi]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="mb-3">
                    <div class="d-block text-center">
                        <img src="{{ url('/images/pengemudi/'. $data->images) }}" alt="" class="rounded" width="50%">
                    </div>
                </div>
                <div class="mb-3">
