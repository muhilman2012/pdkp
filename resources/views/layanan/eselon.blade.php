...
<head>
    ...
    <title>Form Permintaan Eselon - Pelayanan Dukungan Kendaraan & Pengemudi</title>
</head>
...
<body>
    <section class="flex flex-col justify-start px-4 mx-auto bg-white max-w-md pt-5 pb-10 h-full text-black bg-center bg-cover bg-[url('/assets/images/bg-main.png')]">
        ...
        <div class="flex mt-5 items-center justify-center gap-2 w-full">
            ...
            <p class="font-bold text-lg leading-5 w-full">Dukungan Layanan Untuk Eselon</p>
        </div>

        <div class="flex flex-col gap-6 w-full mt-6">
            <form action="{{ route('layanan.eselon.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
