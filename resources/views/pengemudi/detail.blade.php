    ...
    <section class="flex flex-col justify-start px-4 mx-auto bg-white max-w-md pt-5 pb-10 h-full text-black bg-center bg-cover bg-[url('/assets/images/bg-main.png')]">
        ...
        <div class="flex flex-col gap-6 mt-6">
            ...
            <div class="flex flex-col gap-2">
                ...
                <a class="font-normal text-sm leading-5 underline" href="https://wa.me/62{{ $permintaan->phone }}" target="_blank">{{ $permintaan->pengemudi->phone }}</a>
            </div>
            <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-2">
                <p class="font-semibold text-regular underline">Tujuan</p>
